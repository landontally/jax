...
const ListView$1 = lazy(() => import("./ListView-50e02df3.mjs"));
const RecursivePath = () => {
...
const ListView = lazy(() => import("./ListView-50e02df3.mjs"));
const App = () => {
  const { formatMessage } = useIntl();
...
//# sourceMappingURL=index-4a9aa007.mjs.map
