...
import { j as useEnterprise, g as useAdminUsers } from "./index-95e8649d.mjs";
import { g as getFullName, s as selectAdminPermissions } from "./AuthenticatedApp-7d1fdf0c.mjs";
...
import { M as MagicLinkCE, S as SelectRoles } from "./SelectRoles-3d810b00.mjs";
...
const ModalForm = ({ onSuccess, onToggle }) => {
  ...
  const MagicLink = useEnterprise(
    MagicLinkCE,
    async () => (await import("./MagicLinkEE-03128309.mjs")).MagicLinkEE
  );
...
const ListPage = () => {
  const UsersListPage = useEnterprise(
    ...
    async () => (
      ...
      (await import("./ListPage-5ed3e9d2.mjs")).UserListPageEE
    )
  );
  if (!UsersListPage) {
    return null;
...
//# sourceMappingURL=ListPage-800398cd.mjs.map
