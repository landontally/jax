...
const AuthPage = ({ hasAdmin }) => {
  ...
  const Login$1 = useEnterprise(
    Login,
    async () => (await import("./Login-4eb1fb78.mjs")).LoginEE
  );
  const forms = useEnterprise(
    FORMS,
    async () => (await import("./constants-b3c9cbbf.mjs")).FORMS,
    {
...
const AuthenticatedApp = React.lazy(
  () => import("./AuthenticatedApp-7d1fdf0c.mjs").then((n) => n.A).then((mod) => ({ default: mod.AuthenticatedApp }))
);
const App$2 = ({ authLogo, menuLogo, showReleaseNotification, showTutorials }) => {
  const adminPermissions = useEnterprise(
    ADMIN_PERMISSIONS_CE,
    async () => (await import("./constants-e1d0f820.mjs")).ADMIN_PERMISSIONS_EE,
    {
  ...
  const routes = useEnterprise(
    ROUTES_CE,
    async () => (await import("./constants-e1d0f820.mjs")).ROUTES_EE,
    {
      defaultValue: []
    }
  );
...
const Providers = ({
  ...
  return /* @__PURE__ */ jsx(Provider, { store, children: /* @__PURE__ */ jsx(LanguageProvider, { messages, children: /* @__PURE__ */ jsx(Theme, { themes, children: /* @__PURE__ */ jsx(QueryClientProvider, { client: queryClient, children: /* @__PURE__ */ jsx(
    StrapiAppProvider,
    {
      getPlugin,
      getAdminInjectedComponents,
...
const EditViewPage = ({
  ...
  const Information2 = useEnterprise(
    InformationBoxCE,
    async () => (await import("./InformationBoxEE-bd1d2894.mjs")).InformationBoxEE
  );
  useOnce(() => {
...
const ListViewPage = ({
  ...
  const reviewWorkflowColumns = useEnterprise(
    ...
    async () => (await import("./constants-71ebbb75.mjs")).REVIEW_WORKFLOW_COLUMNS_EE,
    {
  ...
  const ReviewWorkflowsColumns = useEnterprise(
    ...
    async () => {
      const { ReviewWorkflowsStageEE, ReviewWorkflowsAssigneeEE } = await import("./ReviewWorkflowsColumn-65518684.mjs");
  ...
  const reviewWorkflowFilter = useEnterprise(
    ...
    async () => (await import("./constants-71ebbb75.mjs")).REVIEW_WORKFLOW_FILTERS,
    {
...
export {
  ...
  LayoutContent as d,
  Logo as e,
  useTypedSelector as f,
  useAdminUsers as g,
  getDisplayName as h,
  getTranslation as i,
  useEnterprise as j,
  useDebounce as k,
  useTypedDispatch as l,
  setAppTheme as m,
  SETTINGS_LINKS_CE as n,
  isObject as o,
  getBasename as p,
  useTypedStore as q,
  useDragAndDrop as r,
...
//# sourceMappingURL=index-95e8649d.mjs.map
