      ...
      onChange?.(
        {
          target: {
            ...
            value: createdEntity[constants.ASSIGNEE_ATTRIBUTE_NAME]
          }
        },
        true
      );
...
function useReviewWorkflowsStages({ id, layout }, queryOptions = {}) {
  ...
  const meta = React__namespace.useMemo(() => data?.meta ?? { workflowCount: 0 }, [data?.meta]);
      ...
      onChange?.(
        {
          target: {
            ...
            value: createdEntity[constants.STAGE_ATTRIBUTE_NAME],
            type: ""
          }
        },
        true
