...
import { u as useConfiguration, c as createTypedSelector, a as useOnce, b as createRoute, R as RBACProvider, N as NpsSurvey } from "./index-95e8649d.mjs";
...
const CM = React.lazy(
  () => import("./index-95e8649d.mjs").then((n) => n.A).then((mod) => ({ default: mod.App }))
);
const HomePage = React.lazy(
  () => import("./HomePage-bfeba10a.mjs").then((mod) => ({
    default: mod.HomePage
  }))
);
const InstalledPluginsPage = React.lazy(
  () => import("./InstalledPluginsPage-8e9b0b64.mjs").then((mod) => ({
    default: mod.ProtectedInstalledPluginsPage
  }))
);
const MarketplacePage = React.lazy(
  () => import("./MarketplacePage-62e70483.mjs").then((mod) => ({ default: mod.ProtectedMarketplacePage }))
);
const NotFoundPage = React.lazy(
  () => import("./index-95e8649d.mjs").then((n) => n.x).then(({ NotFoundPage: NotFoundPage2 }) => ({ default: NotFoundPage2 }))
);
...
const ProfilePage = React.lazy(
  () => import("./ProfilePage-5359ee40.mjs").then((mod) => ({
    default: mod.ProfilePage
  }))
);
const SettingsPage = React.lazy(
  () => import("./SettingsPage-571f777c.mjs").then((mod) => ({
...
//# sourceMappingURL=AuthenticatedApp-7d1fdf0c.mjs.map
