...
import { f as useTypedSelector, l as useTypedDispatch, s as setLocale, m as setAppTheme } from "./index-95e8649d.mjs";
import { g as getFullName } from "./AuthenticatedApp-7d1fdf0c.mjs";
    ...
    },
    {
      async onSuccess(data2) {
        ...
        if (data2.preferedLanguage) {
          dispatch(setLocale(data2.preferedLanguage));
        }
        dispatch(setAppTheme(data2.currentTheme));
...
//# sourceMappingURL=ProfilePage-5359ee40.mjs.map
